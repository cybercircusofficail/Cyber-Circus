...
const getStepIcon = (number: number): string => {
  switch (number) {
    case 1:
      return "🔍";
    case 2:
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="w-12 h-12 rounded-full flex items-center justify-center mb-2 bg-white/10 backdrop-blur-sm">
    ...
    <section className="py-20 px-4 relative overflow-hidden">
      ...
      <div className="container mx-auto relative">
        ...
        <div className="hidden md:flex justify-center mb-12">
          <div className="h-1 bg-gradient-to-r from-indigo-600 via-blue-500 to-purple-500 w-1/2 rounded-full shadow-lg shadow-indigo-500/30" />
        </div>
          ...
          {activeStep !== null && (
            ...
            >
              <div className="flex items-center mb-4">
                <div className={`w-10 h-10 rounded-full flex items-center justify-center ${steps[activeStep].color}`}>
