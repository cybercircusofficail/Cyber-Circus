...
const StatBox: React.FC<StatBoxProps> = ({ percentage, label }) => {
  return (
    <motion.div
  ...
  return (
    <section className="py-16 px-4 relative overflow-hidden">
      <div className="absolute top-0 left-0 w-full h-full">
        <div className="absolute top-20 left-10 w-24 h-24 rounded-full bg-blue-500/10 blur-3xl" />
        <div className="absolute bottom-20 right-10 w-32 h-32 rounded-full bg-purple-500/10 blur-3xl" />
