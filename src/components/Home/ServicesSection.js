            ...
            >
              ...
              >
                <Card className="h-full relative overflow-hidden shadow-lg border border-gray-200 dark:border-gray-700 rounded-xl bg-white dark:bg-gray-800 backdrop-blur-lg bg-opacity-90 dark:bg-opacity-70">
                  <div className="absolute top-0 right-0 w-40 h-40 bg-blue-100/30 dark:bg-blue-900/10 rounded-full -mr-20 -mt-20"></div>
                  ...
                  <CardContent className="text-start px-5 pb-5 relative z-10">
                    ...
                    <Button className="w-full relative group cursor-pointer rounded-lg py-2 border border-blue-600 text-blue-600 dark:text-blue-400 bg-transparent transition-all overflow-hidden flex items-center justify-between px-4 text-sm">
                      <span className="relative z-10 transition-all group-hover:text-white">
                        Learn More
                      </span>
                      <span className="absolute inset-0 w-0 bg-blue-600 transition-all duration-300 ease-in-out group-hover:w-full"></span>
